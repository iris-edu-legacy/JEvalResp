...
c	character*30 datime
 ...
 100	continue
	...
	CALL EVRESP(sta,chan,net,loc,datime,units,filename, freqs, nfreqs, resp, rtype, verbose, start_stage, stp_stage, stdio_flag, stalen, chalen, netlen, loclen, datimelen, unitlen, filelen, rtypelen, verboselen)
